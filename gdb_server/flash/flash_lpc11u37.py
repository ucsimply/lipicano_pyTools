...
class Flash_LPC11U37(Flash):
    
    def __init__(self, target):
        super(Flash_LPC11U37, self).__init__(target, flash_algo)

    # TODO - temporary until flash algo is rebuilt with 4K page program size
    def programPage(self, flashPtr, byte_data):
        write_size = 1024
        for i in range(0, 4):
            data = byte_data[i * write_size : (i + 1) * write_size]
